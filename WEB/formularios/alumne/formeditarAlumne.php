...
<body>
    ...
    <form action="./../../acciones/editar.php" method="post">
        ...
        <input type="text" id="Matricula_Alumne" name="Matricula_Alumne" value="<?php echo $ID; ?>" readonly> 
        <br><br>
        <label for="DNI_Alumne">DNI Alumne</label><br>
        <input type="text" id="DNI_Alumne" name="DNI_Alumne" value="<?php echo $array[1];?>" placeholder="Introduzca su DNI - 8 Numeros y letra" pattern="[0-9]{8}[A-Za-z]{1}" readonly>
        <p class="errors"></p>
        <br><br>
        <label for="Nom_Alumne">Nom Alumne</label><br>
        <input onmouseleave="validarNombre()" type="text" id="Nom_Alumne" name="Nom_Alumne" value="<?php echo $array[2]?>"  maxlength="30"required>
        <p class="errors" id="error_nom"></p>
        <br><br>
        <label for="Primer_Cognom_Alumne">Primer Cognom Alumne</label><br>
        <input onmouseleave="validaApellido1()" type="text" id="Primer_Cognom_Alumne" name="Primer_Cognom_Alumne" value="<?php echo $array[3]?>" maxlength="60" required>
        <p class="errors" id="error_cognom1"></p>
        <br><br>
        <label for="Segon_Cognom_Alumne">Segon Cognom Alumne</label><br>
        <input onmouseleave="validaApellido2()" type="text" id="Segon_Cognom_Alumne" name="Segon_Cognom_Alumne" value="<?php echo $array[4]?>" maxlength="60" required>
        <p class="errors" id="error_cognom2"></p>
        <br><br>
        <label for="Telefon_Alumne">Telèfon Alumne</label><br>
        <input onmouseleave="validaTelf()" type="tel" id="Telefon_Alumne" name="Telefon_Alumne" value="<?php echo $array[5]?>" required>
        <p class="errors" id="error_telf"></p>
        <br><br>
        <label for="Correu_Alumne">Correu Alumne</label><br>
        <input onmouseleave="validaEmail()" type="email" id="Correu_Alumne" name="Correu_Alumne" value="<?php echo $array[6]?>" required>
